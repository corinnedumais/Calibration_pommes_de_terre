...
callbacks = [keras.callbacks.ModelCheckpoint("Trained Models/cibles.ckpt", save_weights_only=True, save_best_only=True)]
...
# model = keras.models.load_model('Trained Models/cibles.h5', custom_objects={'dice_loss': dice_loss, 'dice_coeff': dice_coeff})
